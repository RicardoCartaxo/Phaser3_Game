class FoodFightMiniGame extends Phaser.Scene {
    ...
    initLevel(level){
        switch (level) {
            ...
            default:
                ...
                this.foodSpeed = 6;
                this._amountOfFood = 6;
                this._scoreObjective = 80+this._level;
                this._maxTime = 60;
                this._hearts = 4;
                break;
        }
    ...
    create(){
        ...
        //Score
        this.scoreText = 0;
        //Food Items Array so we can manipulate their properties later
        this.foodArr = [];
        ...
        this.scoreText = this.add.text(0,0, "Score: ", {font: "40px impact"});
